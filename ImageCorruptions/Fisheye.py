...
def add_fisheye(image, severity):
    distortion = 0.2 * severity
    output_img = fish(image, distortion)
    RGBA_img = Image.fromarray(output_img)
    RGB_image = RGBA_img.convert('RGB')
